                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group {{ $errors->has('versao') ? 'has-error' : ''}}">
                            ...
                            <input class="form-control" disabled=""  name="versao" type="text" id="versao" value="{{ isset($data->versao) ? $data->versao : ''}}" >
                        ...
                        <div class="form-group {{ $errors->has('dica') ? 'has-error' : ''}}">
                            ...
                            <textarea class="form-control" disabled="" rows="5" name="dica" type="textarea" id="dica" required>{{ isset($data->dica) ? $data->dica : ''}}</textarea>
